...
package com.aris.server.app;

import static com.aris.util.PowerMenuConstants.GLOBAL_ACTION_KEY_BUGREPORT;
import static com.aris.util.PowerMenuConstants.GLOBAL_ACTION_KEY_LOCKDOWN;
...
import com.aris.app.ILineageGlobalActions;
import com.aris.providers.ArisSettings;
import com.aris.util.PowerMenuConstants;
...
public class LineageGlobalActionsService extends SystemService {
    ...
    private String[] getUserConfig() {
        String savedActions = Settings.Secure.getStringForUser(mContentResolver,
                ArisSettings.Secure.POWER_MENU_ACTIONS, UserHandle.USER_CURRENT);
    ...
    private void saveUserConfig() {
        ...
        Settings.Secure.putStringForUser(mContentResolver, ArisSettings.Secure.POWER_MENU_ACTIONS, s, UserHandle.USER_CURRENT);
    }
