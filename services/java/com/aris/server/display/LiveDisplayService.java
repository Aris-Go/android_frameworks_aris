...
import com.aris.server.common.UserContentObserver;
import com.aris.server.display.TwilightTracker.TwilightListener;
...
import com.aris.app.LineageContextConstants;
import com.aris.providers.ArisSettings;
import com.aris.hardware.HSIC;
import com.aris.hardware.ILiveDisplayService;
import com.aris.hardware.LiveDisplayConfig;

import static com.aris.hardware.LiveDisplayManager.MODE_FIRST;
import static com.aris.hardware.LiveDisplayManager.MODE_LAST;
...
public class LiveDisplayService extends SystemService {
    ...
    private final class ModeObserver extends UserContentObserver {
        ...
        private final Uri MODE_SETTING =
                Settings.System.getUriFor(ArisSettings.System.DISPLAY_TEMPERATURE_MODE);
        ...
        int getMode() {
            return getInt(ArisSettings.System.DISPLAY_TEMPERATURE_MODE,
                    mConfig.getDefaultMode());
        }

        boolean setMode(int mode) {
            if (mConfig.hasFeature(mode) && mode >= MODE_FIRST && mode <= MODE_LAST) {
                putInt(ArisSettings.System.DISPLAY_TEMPERATURE_MODE, mode);
    ...
    private int getSunsetCounter() {
        ...
        return Settings.System.getIntForUser(mContext.getContentResolver(),
                ArisSettings.System.LIVE_DISPLAY_HINTED,
                -3,
