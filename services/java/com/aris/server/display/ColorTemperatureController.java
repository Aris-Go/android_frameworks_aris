...
import com.aris.server.display.TwilightTracker.TwilightState;
...
import com.aris.util.ColorUtils;

import static com.aris.hardware.LiveDisplayManager.MODE_AUTO;
import static com.aris.hardware.LiveDisplayManager.MODE_DAY;
import static com.aris.hardware.LiveDisplayManager.MODE_NIGHT;
import static com.aris.hardware.LiveDisplayManager.MODE_OFF;
...
public class ColorTemperatureController extends LiveDisplayFeature {
    ...
    private static final Uri DISPLAY_TEMPERATURE_DAY =
            Settings.System.getUriFor(ArisSettings.System.DISPLAY_TEMPERATURE_DAY);
    private static final Uri DISPLAY_TEMPERATURE_NIGHT =
            Settings.System.getUriFor(ArisSettings.System.DISPLAY_TEMPERATURE_NIGHT);
    ...
    public ColorTemperatureController(Context context,
        ...
        mColorBalanceCurve = com.aris.util.MathUtils.powerCurve(
    ...
    private int mapColorTemperatureToBalance(int temperature) {
        double z = com.aris.util.MathUtils.powerCurveToLinear(mColorBalanceCurve, temperature);
    ...
    int getDayColorTemperature() {
        return getInt(ArisSettings.System.DISPLAY_TEMPERATURE_DAY,
                mDefaultDayTemperature);
    }

    void setDayColorTemperature(int temperature) {
        putInt(ArisSettings.System.DISPLAY_TEMPERATURE_DAY, temperature);
    }

    int getNightColorTemperature() {
        return getInt(ArisSettings.System.DISPLAY_TEMPERATURE_NIGHT,
                mDefaultNightTemperature);
    }

    void setNightColorTemperature(int temperature) {
        putInt(ArisSettings.System.DISPLAY_TEMPERATURE_NIGHT, temperature);
    }
