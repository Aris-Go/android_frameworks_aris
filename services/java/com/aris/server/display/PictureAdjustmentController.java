...
import com.aris.hardware.DisplayMode;
...
public class PictureAdjustmentController extends LiveDisplayFeature {
    ...
    public void onStart() {
        ...
        registerSettings(
                Settings.System.getUriFor(ArisSettings.System.DISPLAY_PICTURE_ADJUSTMENT));
    }
    ...
    private SparseArray<HSIC> unpackPreference() {
        ...
        String pref = getString(ArisSettings.System.DISPLAY_PICTURE_ADJUSTMENT);
        if (pref != null) {
    ...
    private void packPreference(final SparseArray<HSIC> modes) {
        ...
        putString(ArisSettings.System.DISPLAY_PICTURE_ADJUSTMENT, sb.toString());
    }
