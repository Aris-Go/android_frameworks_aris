...
import static com.aris.hardware.LiveDisplayManager.MODE_OUTDOOR;
...
public class OutdoorModeController extends LiveDisplayFeature {
    ...
    public void onStart() {
        ...
        registerSettings(
                Settings.System.getUriFor(ArisSettings.System.DISPLAY_AUTO_OUTDOOR_MODE));
    }
    ...
    boolean setAutomaticOutdoorModeEnabled(boolean enabled) {
        ...
        putBoolean(ArisSettings.System.DISPLAY_AUTO_OUTDOOR_MODE, enabled);
        return true;
    }

    boolean isAutomaticOutdoorModeEnabled() {
        return mUseOutdoorMode && (mNightDisplayAvailable ||
                getBoolean(ArisSettings.System.DISPLAY_AUTO_OUTDOOR_MODE,
