 ...
 */
package com.aris.server.display;
...
import com.aris.hardware.LineageHardwareManager;
import com.aris.hardware.LiveDisplayManager;
...
public class DisplayHardwareController extends LiveDisplayFeature {
    ...
    private static final Uri DISPLAY_AUTO_CONTRAST =
            Settings.System.getUriFor(ArisSettings.System.DISPLAY_AUTO_CONTRAST);
    private static final Uri DISPLAY_COLOR_ADJUSTMENT =
            Settings.System.getUriFor(ArisSettings.System.DISPLAY_COLOR_ADJUSTMENT);
    private static final Uri DISPLAY_COLOR_ENHANCE =
            Settings.System.getUriFor(ArisSettings.System.DISPLAY_COLOR_ENHANCE);
    private static final Uri DISPLAY_CABC =
            Settings.System.getUriFor(ArisSettings.System.DISPLAY_CABC);
    private static final Uri DISPLAY_READING_MODE =
            Settings.System.getUriFor(ArisSettings.System.DISPLAY_READING_MODE);
    private static final Uri DISPLAY_ANTI_FLICKER =
            Settings.System.getUriFor(ArisSettings.System.DISPLAY_ANTI_FLICKER);
    ...
    boolean isAutoContrastEnabled() {
        return mUseAutoContrast &&
                getBoolean(ArisSettings.System.DISPLAY_AUTO_CONTRAST, mDefaultAutoContrast);
    }
    ...
    boolean setAutoContrastEnabled(boolean enabled) {
        ...
        putBoolean(ArisSettings.System.DISPLAY_AUTO_CONTRAST, enabled);
        return true;
    }

    boolean isCABCEnabled() {
        return mUseCABC &&
                getBoolean(ArisSettings.System.DISPLAY_CABC, mDefaultCABC);
    }
    ...
    boolean setCABCEnabled(boolean enabled) {
        ...
        putBoolean(ArisSettings.System.DISPLAY_CABC, enabled);
        return true;
    }

    boolean isColorEnhancementEnabled() {
        return mUseColorEnhancement &&
                getBoolean(ArisSettings.System.DISPLAY_COLOR_ENHANCE,
    ...
    boolean setColorEnhancementEnabled(boolean enabled) {
        ...
        putBoolean(ArisSettings.System.DISPLAY_COLOR_ENHANCE, enabled);
        return true;
    }
    ...
    float[] getColorAdjustment() {
        ...
        if (!parseColorAdjustment(getString(ArisSettings.System.DISPLAY_COLOR_ADJUSTMENT), cur)) {
    ...
    private void saveColorAdjustmentString(final float[] adj) {
        ...
        putString(ArisSettings.System.DISPLAY_COLOR_ADJUSTMENT, sb.toString());
    }
    ...
    boolean isAntiFlickerEnabled() {
        return mUseAntiFlicker &&
                getBoolean(ArisSettings.System.DISPLAY_ANTI_FLICKER, mDefaultAntiFlicker);
    }
    ...
    boolean setAntiFlickerEnabled(boolean enabled) {
        ...
        putBoolean(ArisSettings.System.DISPLAY_ANTI_FLICKER, enabled);
        return true;
    }
}
