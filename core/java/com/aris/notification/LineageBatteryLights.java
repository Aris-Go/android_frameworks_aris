    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    ArisSettings.System.BATTERY_LIGHT_ENABLED), false, this,
                    UserHandle.USER_ALL);

            // Battery light disabled if fully charged
            resolver.registerContentObserver(Settings.System.getUriFor(
                    ArisSettings.System.BATTERY_LIGHT_FULL_CHARGE_DISABLED), false, this,
                    UserHandle.USER_ALL);

            // Low battery pulse
            resolver.registerContentObserver(Settings.System.getUriFor(
                    ArisSettings.System.BATTERY_LIGHT_PULSE), false, this,
                    UserHandle.USER_ALL);

            if (mMultiColorBatteryLed) {
                // Light colors
                resolver.registerContentObserver(Settings.System.getUriFor(
                        ArisSettings.System.BATTERY_LIGHT_LOW_COLOR), false, this,
                        UserHandle.USER_ALL);
                resolver.registerContentObserver(Settings.System.getUriFor(
                        ArisSettings.System.BATTERY_LIGHT_MEDIUM_COLOR), false, this,
                        UserHandle.USER_ALL);
                resolver.registerContentObserver(Settings.System.getUriFor(
                        ArisSettings.System.BATTERY_LIGHT_FULL_COLOR), false, this,
                        UserHandle.USER_ALL);
            }
            ...
            if (mCanAdjustBrightness) {
                ...
                resolver.registerContentObserver(Settings.System.getUriFor(
                        ArisSettings.System.BATTERY_LIGHT_BRIGHTNESS_LEVEL), false, this,
                        UserHandle.USER_ALL);
                // Battery brightness level in Do Not Disturb mode
                resolver.registerContentObserver(Settings.System.getUriFor(
                        ArisSettings.System.BATTERY_LIGHT_BRIGHTNESS_LEVEL_ZEN), false, this,
                        UserHandle.USER_ALL);
            }
        ...
        private void update() {
            ...
            if (mCanAdjustBrightness) {
                ...
                mBatteryBrightnessLevel = Settings.System.getIntForUser(resolver,
                        ArisSettings.System.BATTERY_LIGHT_BRIGHTNESS_LEVEL,
                ...
                mBatteryBrightnessZenLevel = Settings.System.getIntForUser(resolver,
                        ArisSettings.System.BATTERY_LIGHT_BRIGHTNESS_LEVEL_ZEN,
                        LedValues.LIGHT_BRIGHTNESS_MAXIMUM, UserHandle.USER_CURRENT);
            }
